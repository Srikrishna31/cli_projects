...
#[case(&[TEN, EMPTY, ONE, THREE, TWO], "tests/expected/all.out")]
#[case(&[TEN, EMPTY, ONE, THREE, TWO, "-n", "0"], "tests/expected/all.n0.out")] // Failing case
...
#[case(&[TEN, EMPTY, ONE, THREE, TWO, "-c", "0"], "tests/expected/all.c0.out")] // Failing case
